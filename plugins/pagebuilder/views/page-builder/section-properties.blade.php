...
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="content-info" role="tabpanel" aria-labelledby="content-info-tab">
        ...
        <div class="form-row mb-20">
            <div class="col-sm-12">
                <label class="font-14 bold black">{{ translate('CSS Class') }} </label>
            </div>
            <div class="col-sm-12">
                <div class="input-group addon">


                    <input type="text" name="css_class" class="color-input form-control style--two"
                        placeholder="class1 class2" value="{{ isset($section_properties['css_class']) ? $section_properties['css_class'] : '' }}">
                </div>
            </div>
        </div>
